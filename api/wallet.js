...
module.exports = withAuth(async (req, res, userId) => {
  ...
  await sql`
    INSERT INTO wallet_v2
      (user_id, common, legendary, mythic, last_purchase_date, last_purchase_item_name, last_purchase_item_rarity)
    VALUES
      (${userId}, ${common}, ${legendary}, ${mythic}, ${last_purchase_date ?? null}, ${last_purchase_item_name ?? null}, ${last_purchase_item_rarity ?? null})
