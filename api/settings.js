...
module.exports = withAuth(async (req, res, userId) => {
  ...
  const { reset_hour, has_completed_onboarding, onboarding_ritual_count, has_shown_record_tutorial, has_shown_bazaar_tutorial } = req.body;
  ...
  await sql`
    INSERT INTO settings_v2 (user_id, reset_hour, has_completed_onboarding, onboarding_ritual_count, has_shown_record_tutorial, has_shown_bazaar_tutorial)
    VALUES (${userId}, ${rh}, ${hco}, ${orc}, ${hsr}, ${hsb})
