...
module.exports = withAuth(async (req, res, userId) => {
  ...
  await sql`ALTER TABLE wallet_v2 ADD COLUMN IF NOT EXISTS sparks int NOT NULL DEFAULT 0`;
  await sql`
  ...
  await sql`ALTER TABLE tasks_v2 ADD COLUMN IF NOT EXISTS mark text`;
  await sql`
